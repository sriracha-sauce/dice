...
(function(dice) {
    ...
    this.create_d4_geometry = function(radius) {
        ...
        return create_geom(vertices, faces, radius * dice_scale, -0.1, Math.PI * 7 / 6, 0.96);
    }
    ...
    this.create_d6_geometry = function(radius) {
        ...
        return create_geom(vertices, faces, radius * dice_scale * 1.2, 0.1, Math.PI / 4, 0.96);
    }
    ...
    this.create_d8_geometry = function(radius) {
        ...
        return create_geom(vertices, faces, radius * dice_scale, 0, -Math.PI / 4 / 2, 0.965);
    }
    ...
    this.create_d10_geometry = function(radius) {
        ...
        return create_geom(vertices, faces, radius * dice_scale, 0, Math.PI * 6 / 5, 0.945);
    }
    ...
    this.create_d12_geometry = function(radius) {
        ...
        return create_geom(vertices, faces, radius * dice_scale, 0.2, -Math.PI / 4 / 2, 0.968);
    }
    ...
    this.create_d20_geometry = function(radius) {
        ...
        return create_geom(vertices, faces, radius * dice_scale, -0.2, -Math.PI / 4 / 2, 0.955);
    }
	...
	// yotz change (original = 0xf0f5fb)
    this.ambient_light_color = 0xf0f5fb;
	// yotz change (original = 0xefdfd5)
    this.spot_light_color = 0xefdfd5;
	// yotz change (original = 0x404040 / 0 / 0x858787 )
	this.selector_back_colors = { color: 0x645b49, shininess: 0, emissive: 0x858787 };
	// yotz change (original = 0xdfdfdf)
    this.desk_color = 0xcdc6b3;
    ...
    this.dice_box.prototype.draw_selector = function() {
        this.clear();
		// yotz change
        var step = this.w / 4.5 * dice_scale / 1.2;
